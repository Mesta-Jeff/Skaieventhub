...
Route::middleware([CsrfExempt::class])->group(function () {
    ...
    Route::get('auth/change-password', [WebAuthenticationController::class, 'change_password'])->name('change-password');
    Route::get('auth/recover-password', [WebAuthenticationController::class, 'recover_password'])->name('recover-password');
    Route::get('auth/reset-password', [WebAuthenticationController::class, 'reset_password'])->name('reset-password');
    Route::get('auth/verify-email', [WebAuthenticationController::class, 'verify_email'])->name('verify-email');
    Route::get('auth/lock-screen', [WebAuthenticationController::class, 'lock_screen'])->name('lock-screen');
...
Route::middleware([CheckSessionValue::class])->group(function () {
    ...
    Route::get('auth/logout', [WebAuthenticationController::class, 'logout'])->name('logout');

    // Bulk remove
    Route::post('/settings/bulk-remove', [WebSettingsController::class, 'bulkRemove'])->name('settings.bulk-remove');

    // Management Routes
    Route::get('management/dashboard', [WebManagementController::class, 'dashboard'])->name('management.dashboard');
    Route::get('client/dashboard', [WebClientController::class, 'dashboard'])->name('client.dashboard');
