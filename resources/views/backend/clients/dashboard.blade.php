                    ...
                    <div class="d-flex align-items-start align-items-center">
                        <div class="w-100 overflow-hidden">
                            <h2 class="m-0 cta-box-title text-reset">
                                ...
                                Please be informed that you have a pending payment to make on your created event [..] please do so as before you can do any other things
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h4 class="mt-0 mb-1 font-20">{{ $info['views'] ?? '--' }}</h4>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h4 class="mt-0 mb-1 font-20">{{ $info['comments'] ?? '--' }}</h4>
                                </div>
                            </div>
                            <div class="row align-items-end justify-content-between mt-1">
                                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h4 class="mt-0 mb-1 font-20">{{ $info['stars'] ?? '--' }}</h4>
                                </div>
                            </div>
                            <div class="row align-items-end justify-content-between mt-1">
                                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h4 class="mt-0 mb-1 font-20">{{ $info['likes'] ?? '--' }}</h4>
                                </div>
                            </div>
                            <div class="row align-items-end justify-content-between mt-1">
                                <div class="col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div id="event-container" class="card-body pt-0 mb-2" data-simplebar style="max-height: 150px;">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <div class="avatar-sm rounded">
                                                <span class="avatar-title bg-success-lighten text-success border border-success rounded-circle h3 my-0">{{ $loop->index + 1 }}</span>
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-2">
                                            <h4 class="mt-0 mb-1 font-16 fw-semibold">{{ $item->event_title }}</h4>
                                            {{-- <p class="mb-0 text-muted">Event type: </p> --}}
                                            <p class="mb-0 me-1 text-muted">Type: <span class="mb-0 text-success">{{ $item->event_type }}</span></p>
                                        </div>
                                        <p class="mb-0 me-1 text-muted"><i class="mdi mdi-briefcase me-1"></i>Date:<p class="mb-0 text-success">{{ $item->created_at }}</p></p>
                                    </div>
                                    <hr>
                                @endforeach
                            ...
                            @else
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1 ms-2">
                                        <h4 class="mt-0 mb-1 font-16 fw-semibold">No event added by you</h4>
                                    </div>
                                </div>
                            @endif
