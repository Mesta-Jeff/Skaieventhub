                        ...
                        <div class="booking-sidebar shadow">
                            ...
                            <div class="widget">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <span class="text-center">Amount to pay for the subscription and setup only <h2 class="price">GHS{{ $info['price'] ?? 'GHS00.00' }}</h2></span>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-grp">
                                        <div class="form">
                                            ...
                                            <input type="text" id="set" placeholder="eg. odenehonas1@gmail.com">
                                        </div>
                                    </div>
                                </div>
                                <div class="text-center">
                                    <a id="save-data" class="btn">Re-Initialize Payment</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.info) {
                        ...
                        $('.price').text('GHS' + (eventInfo.price ?? '00.00'));
                        // location.reload();
                    } else {
