...
<head>
  ...
  <meta property="og:image" content="{{ asset('root/hyp/assets/images/logo-dark-sm.png') }}">
        ...
        <div class="landing-intro">
          <section class="landing-header px-5 lg:px-8" ng-reflect-ng-class="[object Object]">
            <div class="landing-header-container">
              <span>
                <a href="">
                  <img height="70" alt="PrimeNG" priority="" class="landing-header-logo"
                    src="{{ asset('root/hyp/assets/images/logo-dark-sm.png') }}">
                </a>
              </span>
            ...
            <div class="hero-inner z-2 relative">
              <div class="flex flex-column md:align-items-center md:flex-row">
                ...
                <div class="p-2 flex flex-row md:flex-column">
                  {{-- <a href="">
                    <div class="hero-box w-10rem h-10rem md:w-12rem md:h-12rem animation flex align-items-center justify-content-center">
                      <div class="flex flex-column align-items-center"><i class="pi pi-book" style="font-size: 30px; color:teal !important"></i>
                        <div class="name"><b style="color: teal">Terms & Conditions</b><span>know more about us</span></div>
                      </div>
                    </div>
                  </a> --}}
                ...
                <div class="p-2 flex flex-row md:flex-column">
                  ...
                  <a href="{{ route('login')}}" id="come">
                    <div class="hero-box w-10rem h-10rem md:w-12rem md:h-12rem animation logo hidden md:flex my-4 align-items-center justify-content-center">
                      <div class="hero-box-inner text-center"><i class="pi pi-desktop" style="font-size: 30px; color:teal !important"></i>
                        <div class="name"><b class="font-bold" style="color:teal !important">My Account</b><span>Get to Dashboard</span></div>
                      </div>
                    </div>
                  </a>
                  <a href="{{ route('login')}}">
                    <div class="hero-box w-10rem h-10rem md:w-12rem md:h-12rem animation flex ml-4 md:ml-0 align-items-center justify-content-center">
                      <div class="flex flex-column align-items-center"><i class="pi pi-user" style="font-size: 30px; color:teal !important"></i>
                        <div class="name"><b style="color: teal">Sign In</b><span>Get to Dashboard</span></div>
                      </div>
                    </div>
                  </a>
                </div>
                ...
                <div class="p-2 flex flex-row md:flex-column">
                  <a href="">
                    <div class="hero-box w-10rem h-10rem md:w-12rem md:h-12rem animation flex align-items-center justify-content-center">
                      <div class="flex flex-column align-items-center"><i class="pi pi-sitemap" style="font-size: 30px; color:teal !important"></i>
                        <div class="name"><b style="color: teal">Main Site</b><span>Visit our website</span></div>
                      </div>
                    </div>
                  </a>
                  {{-- <a href="">
                    <div class="hero-box w-10rem h-10rem md:w-12rem md:h-12rem animation flex ml-4 md:ml-0 md:mt-4 align-items-center justify-content-center">
                      <div class="flex flex-column align-items-center"><i class="pi pi-database" style="font-size: 30px; color:teal !important"></i>
                        <div class="name"><b style="color: teal">Financial Slot</b><span>Get financial status</span></div>
                      </div>
                    </div>
                  </a> --}}
                </div>
